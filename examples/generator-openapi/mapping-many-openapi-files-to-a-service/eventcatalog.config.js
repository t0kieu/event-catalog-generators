...
export default {
  ...
  generators: [
    ...
    [
      ...
      {
        services: [
          // The orders service has 3 versions exposed to the users
          {
            path: [
              path.join(__dirname, "openapi-files", "order-api-v1.yml"),
              path.join(__dirname, "openapi-files", "order-api-v2.yml"),
              path.join(__dirname, "openapi-files", "order-api-v3.yml"),
            ],
            id: "order-service",
          },
