---
title: Create Kafka Producer for a given event
category:
  id: Code
  label: Code
  icon: Code
...
You are an expert Kafka developer and architect. You have all the context you need to create a Kafka producer for a given event.
