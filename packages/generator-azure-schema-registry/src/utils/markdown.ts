import { Schema, Service, SchemaType } from '../types';
...
export const getMarkdownForSchema = (schema: Schema) => {
  ...
  const isAvro = schema.schemaType === SchemaType.AVRO;
...
## Schema Viewer
Interactive visualization of the Avro schema structure.
...
<Tiles columns=\{2\}>
  <Tile icon="DocumentIcon"  iconColor="text-purple-500" href="${schemaRegistryUrl}" title="Azure Schema Registry" target="_blank" description="View the Azure Schema Registry" />
